...
export default {
  subscriptions: null,
  decorations: [],
  loadingDecorationsByLineNumber: {},
  styleElementIds: [],
  ...
  activate() {
    ...
    // editor.onDidStopChanging(() => this.attachLabels())
  ...
  removeLabels() {
    ...
    Object.values(this.loadingDecorationsByLineNumber).map(d => d.destroy())
    this.loadingDecorationsByLineNumber = {}
  ...
  handleCalculatingStart(packages) {
    ...
    packages.map(({ line }) => {
      ...
      this.loadingDecorationsByLineNumber[line] = decoration;
    })
  },
  ...
  handleCalculatedPackage(package) {
    ...
    // Destroy the loading decorator for this line
    this.loadingDecorationsByLineNumber[line].destroy()
